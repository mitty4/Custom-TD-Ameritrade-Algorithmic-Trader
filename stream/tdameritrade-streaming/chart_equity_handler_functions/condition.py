...
def trigger(live_df, hist_df):
    ...
    volume75 = live_df['VOLUME'] >= np.percentile(hist_df['volume'],[30])[0] #90
    ...
    return high_not_zero[0] & low_not_zero[0] & tall_candle[0] & volume75[0] & not_first15[0] & price65th[0] & not_penny[0] & not_last60[0]