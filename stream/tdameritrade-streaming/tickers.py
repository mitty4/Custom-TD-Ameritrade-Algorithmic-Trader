...
long_term = 'AAPL', 'GOOG','DIS','FDX','JNJ','MCD','SHOP','SQ','WMT','WM'
short_term = 'FTEK','DPW','PTE','IDEX','CIIC','BLPH','PEI','GME','GRAY','NAKD','RENN','AYRO'
today = 'KNDI','SRNE','KGC','INO','PEIX','GME','FUV','UMC','MGNI'


beta = ['NCTY', 'MARA', 'SOL', 'PECK', 'RIOT', 'RESN', 'ENG', 'CLSK', 'AMRS', 'ZKIN', 'XNET', 'OCX', 'CRIS', 'FTEK', 'GEVO', 'UAVS', 'DPW', 'PIXY', 'AWX', 'MGI', 'XXII', 'XBIO', 'LXRX']

idk = ['CODA','PFLT', 'SSSS', 'QRVO', 'CALB', 'CNS', 'HXL', 'IBN', 'KAI', 'KMX', 'LEG', 'LOW', 'MPX', 'RF','TPL', 'WWE', 'SPB', 'PZN', 'AAT', 'APTV', 'HY', 'SCM', 'RGT']
